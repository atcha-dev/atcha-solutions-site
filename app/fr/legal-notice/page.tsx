    ...
    <main className="grain min-h-screen px-5 py-6 text-[var(--foreground)] sm:px-8 lg:px-10">
      <div className="mx-auto legal-page">
        ...
        <section className="legal-stack mt-6">
          <article className="glass-card rounded-[2rem] px-6 py-7 sm:px-8"><h2>Éditeur</h2><ul className="mt-4 space-y-2"><li>Nom commercial : Atcha Solutions</li><li>Entité légale : Atcha Invest OÜ</li><li>Code registre : 16393220</li><li>Forme légale : OÜ</li><li>Siège : Tallinn, Estonie</li><li>Email : <a href="mailto:atchasolutions@pm.me">atchasolutions@pm.me</a></li></ul></article>
